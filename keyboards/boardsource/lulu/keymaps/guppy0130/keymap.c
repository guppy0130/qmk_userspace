...
LSFT_T(KC_TAB),   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,\
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                 KC_LGUI, KC_LGUI,  KC_GRV,  LOWER,       RAISE,  KC_SPC, KC_RALT, KC_RALT \
                             //`-----------------------------------'  `-----------------------------------'
  ...
  //|--------+--------+--------+--------+--------+--------|--------|  |--------|--------+--------+--------+--------+--------+--------|
      KC_LCTL,   KC_F7,   KC_F8,   KC_F8,  KC_F10,  KC_F11, XXXXXXX,    XXXXXXX,  KC_F12, KC_HOME, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                 KC_LGUI, KC_LGUI,  KC_GRV,  LOWER,       RAISE,  KC_SPC,  KC_END, KC_END \
                             //`-----------------------------------'  `-----------------------------------'
    ),
...
static void render_luna(int LUNA_X, int LUNA_Y) {
    ...
    void animation_phase(void) {
        ...
        // switch frame
        // https://filterpaper.github.io/qmk/savingbytes.html#avoid-division
